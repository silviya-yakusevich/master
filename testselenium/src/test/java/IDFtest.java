...
public class IDFtest {
    ...
    public static class idf_Master {
    ...
    public static class idf_Prod{
        ...
        public void setUp()
        {
            ...
            driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
            driver.manage().window().maximize();
            driver.get("https://idfinance.com/");
     ...
     public void checkResponseCodeEN () throws IOException {
         idFinance.checkResponseCode(idFinance.enLang);
      }


      @Test
      public void checkResponseCodeES () throws IOException {
          idFinance.checkResponseCode(idFinance.esLang);
      }


    @Test
    public void thereAreNoIndexEn(){

        Assert.assertEquals("There are no noindex,nofollow", idFinance.noIndex());

    }
    @Test
    public void thereAreNoIndexEs(){

         driver.findElement(idFinance.esLang).click();
         Assert.assertEquals("There are no noindex,nofollow", idFinance.noIndex());
    }
